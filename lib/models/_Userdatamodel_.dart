...
class Userdatamodel {
  ...
  static Future<dynamic> connect(String log, String mdp) async {
    final response = await http.post(Uri.parse("${MainApp.baseUrl}/connect_userdata.php"), 
  ...
  static Future<dynamic> createUser(String name, String xlmcontent) async {
    final response = await http.post(Uri.parse("${MainApp.baseUrl}/create_userdata.php"),
  ...
  static Future<List<Utilisateur>> getAllUsers() async {
    final response = await http.get(Uri.parse("${MainApp.baseUrl}/read_userdata.php"));
  ...
  static Future<Utilisateur> getOneUser(BigInt id) async {
    final response = await http.post(Uri.parse("${MainApp.baseUrl}/read_one_userdata.php"),
  ...
  static Future<dynamic> updateUser(BigInt id, String name, String xlmcontent) async {
    final response = await http.post(Uri.parse("${MainApp.baseUrl}/update_userdata.php"),
  ...
  static Future<dynamic>deleteUser(BigInt id) async {
    final response = await http.post(Uri.parse("${MainApp.baseUrl}/delete_userdata.php"),
      body: jsonEncode(<String, dynamic> { "id": id.toString() }),
    );
    if (response.statusCode == 200) {
